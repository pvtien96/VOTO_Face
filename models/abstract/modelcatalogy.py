...
class ModelCatalog(object):
    ...
    def register(name, func):
        ...
        """
        assert callable(
            func), "You must register a function with `ModelCatalog.register`!"
    ...
    def get(name, cfg):
        ...
        try:
            ...
            raise KeyError(
                "Model '{}' is not registered! Available datasets are: {}".
                format(name, ", ".join(ModelCatalog._REGISTERED.keys())))
        return f(cfg)
